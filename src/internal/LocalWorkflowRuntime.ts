...
// 	}
// 	public abstract scheduleActivity<TEnterContext, TExitContext, TScheduleContext extends TEnterContext>(
// 		cancellationToken: CancellationToken, activity: Activity<TEnterContext, TExitContext>, context: TScheduleContext
// 	): Promise<void>;
...
// 	public async scheduleActivity<TEnterContext, TExitContext, TScheduleContext extends TEnterContext>(
// 		cancellationToken: CancellationToken, activity: Activity<TEnterContext, TExitContext>, context: TScheduleContext
// 	): Promise<void> {
...
// 	public async scheduleActivity<TEnterContext, TExitContext>(
// 		cancellationToken: CancellationToken, activity: Activity<TEnterContext, TExitContext>, context: TEnterContext
// 	): Promise<void> {
// 		const childRuntime = new WorkerLocalWorkflowRuntime(activity, this._rootRuntime);
// 		return await childRuntime.exec(cancellationToken, activity, context);
// 	}

// 	public async exec<TEnterContext, TExitContext>(
// 		cancellationToken: CancellationToken, activity: Activity<TEnterContext, TExitContext>, context: TEnterContext
// 	): Promise<void> {
